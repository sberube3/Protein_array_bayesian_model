...
percentiles_1<- read.csv("Malaria_Percentiles_Array_1_alpha25.csv")
percentiles_2<- read.csv("Malaria_Percentiles_Array_2_alpha25.csv")
percentiles_3<- read.csv("Malaria_Percentiles_Array_3_alpha25.csv")
percentiles_4<- read.csv("Malaria_Percentiles_Array_4_alpha25.csv")
percentiles_5<- read.csv("Malaria_Percentiles_Array_5_alpha25.csv")
percentiles_6<- read.csv("Malaria_Percentiles_Array_6_alpha25.csv")
percentiles_7<- read.csv("Malaria_Percentiles_Array_7_alpha25.csv")
percentiles_8<- read.csv("Malaria_Percentiles_Array_8_alpha25.csv")
percentiles_9<- read.csv("Malaria_Percentiles_Array_9_alpha25.csv")
percentiles_10<- read.csv("Malaria_Percentiles_Array_10_alpha25.csv")
...
percentiles_1<- read.csv("Malaria_Percentiles_Array_1_alpha25Model2.csv")
percentiles_2<- read.csv("Malaria_Percentiles_Array_2_alpha25Model2.csv")
percentiles_3<- read.csv("Malaria_Percentiles_Array_3_alpha25Model2.csv")
percentiles_4<- read.csv("Malaria_Percentiles_Array_4_alpha25Model2.csv")
percentiles_5<- read.csv("Malaria_Percentiles_Array_5_alpha25Model2.csv")
percentiles_6<- read.csv("Malaria_Percentiles_Array_6_alpha25Model2.csv")
percentiles_7<- read.csv("Malaria_Percentiles_Array_7_alpha25Model2.csv")
percentiles_8<- read.csv("Malaria_Percentiles_Array_8_alpha25Model2.csv")
percentiles_9<- read.csv("Malaria_Percentiles_Array_9_alpha25Model2.csv")
percentiles_10<- read.csv("Malaria_Percentiles_Array_10_alpha25Model2.csv")


malaria_percentiles_1_2<- c(percentiles_1$x,
                            percentiles_2$x,
                            percentiles_3$x,
                            percentiles_4$x,
                            percentiles_5$x,
...
Malaria_perc_res_df<- as.data.frame(cbind(c(malaria_percentiles_1_2),
                                          rep(c("Model 1"),
                                              length(malaria_percentiles_1_2))))
...
percentiles_1<- read.csv("Malaria_Percentiles_Array_1_alpha25Model3.csv")
percentiles_2<- read.csv("Malaria_Percentiles_Array_2_alpha25Model3.csv")
percentiles_3<- read.csv("Malaria_Percentiles_Array_3_alpha25Model3.csv")
percentiles_4<- read.csv("Malaria_Percentiles_Array_4_alpha25Model3.csv")
percentiles_5<- read.csv("Malaria_Percentiles_Array_5_alpha25Model3.csv")
percentiles_6<- read.csv("Malaria_Percentiles_Array_6_alpha25Model3.csv")
percentiles_7<- read.csv("Malaria_Percentiles_Array_7_alpha25Model3.csv")
percentiles_8<- read.csv("Malaria_Percentiles_Array_8_alpha25Model3.csv")
percentiles_9<- read.csv("Malaria_Percentiles_Array_9_alpha25Model3.csv")
percentiles_10<- read.csv("Malaria_Percentiles_Array_10_alpha25Model3.csv")


malaria_percentiles_1_3<- c(percentiles_1$x,
                            percentiles_2$x,
                            percentiles_3$x,
                            percentiles_4$x,
                            percentiles_5$x,
...
Malaria_perc_res_df<- as.data.frame(cbind(c(malaria_percentiles_1_3),
                                          rep(c("Model 1"),
                                              length(malaria_percentiles_1_3))))
...
malaria_percentiles_2_1<- c(percentiles_1$x,
                            percentiles_2$x,
                            percentiles_3$x,
                            percentiles_4$x,
                            percentiles_5$x,
...
Malaria_perc_res_df<- as.data.frame(cbind(c(malaria_percentiles_2_1),
                                          rep(c("Model 1"),
                                              length(malaria_percentiles_2_1))))
...
percentiles_1<- read.csv("Malaria_Percentiles_Array_1_alpha1Model2.csv")
percentiles_2<- read.csv("Malaria_Percentiles_Array_2_alpha1Model2.csv")
percentiles_3<- read.csv("Malaria_Percentiles_Array_3_alpha1Model2.csv")
percentiles_4<- read.csv("Malaria_Percentiles_Array_4_alpha1Model2.csv")
percentiles_5<- read.csv("Malaria_Percentiles_Array_5_alpha1Model2.csv")
percentiles_6<- read.csv("Malaria_Percentiles_Array_6_alpha1Model2.csv")
percentiles_7<- read.csv("Malaria_Percentiles_Array_7_alpha1Model2.csv")
percentiles_8<- read.csv("Malaria_Percentiles_Array_8_alpha1Model2.csv")
percentiles_9<- read.csv("Malaria_Percentiles_Array_9_alpha1Model2.csv")
percentiles_10<- read.csv("Malaria_Percentiles_Array_10_alpha1Model2.csv")


malaria_percentiles_2_2<- c(percentiles_1$x,
                            percentiles_2$x,
                            percentiles_3$x,
                            percentiles_4$x,
                            percentiles_5$x,
...
Malaria_perc_res_df<- as.data.frame(cbind(c(malaria_percentiles_2_2),
                                          rep(c("Model 1"),
                                              length(malaria_percentiles_2_2))))
...
percentiles_1<- read.csv("Malaria_Percentiles_Array_1_alpha1Model3.csv")
percentiles_2<- read.csv("Malaria_Percentiles_Array_2_alpha1Model3.csv")
percentiles_3<- read.csv("Malaria_Percentiles_Array_3_alpha1Model3.csv")
percentiles_4<- read.csv("Malaria_Percentiles_Array_4_alpha1Model3.csv")
percentiles_5<- read.csv("Malaria_Percentiles_Array_5_alpha1Model3.csv")
percentiles_6<- read.csv("Malaria_Percentiles_Array_6_alpha1Model3.csv")
percentiles_7<- read.csv("Malaria_Percentiles_Array_7_alpha1Model3.csv")
percentiles_8<- read.csv("Malaria_Percentiles_Array_8_alpha1Model3.csv")
percentiles_9<- read.csv("Malaria_Percentiles_Array_9_alpha1Model3.csv")
percentiles_10<- read.csv("Malaria_Percentiles_Array_10_alpha1Model3.csv")


malaria_percentiles_2_3<- c(percentiles_1$x,
                            percentiles_2$x,
                            percentiles_3$x,
                            percentiles_4$x,
                            percentiles_5$x,
...
Malaria_perc_res_df<- as.data.frame(cbind(c(malaria_percentiles_2_3),
                                          rep(c("Model 1"),
                                              length(malaria_percentiles_2_3))))
...
global_malaria_sim_data<- as.data.frame(cbind(c(malaria_percentiles_1_1,
                                                malaria_percentiles_1_2,
                                                malaria_percentiles_1_3,
                                                malaria_percentiles_2_1,
                                                malaria_percentiles_2_2,
                                                malaria_percentiles_2_3),
                                              c(rep(c("Data A","Data B", "Data C"),
                                                    each=10380,times=2)),
                                              c(rep(c("Model 1", "Model 2"),
                                                    each=10380*3))))

colnames(global_malaria_sim_data)<- c("P_double_dagger","Generated_Dat","Analysis_Mod")

global_malaria_sim_data$P_double_dagger<- as.numeric(global_malaria_sim_data$P_double_dagger)
percentile_facet_plot<- ggplot(global_malaria_sim_data,aes(sample=P_double_dagger))+
  stat_qq(size=0.75)+
  geom_abline(slope=1,intercept=0,color="red")+
  facet_grid(Generated_Dat~Analysis_Mod)+
  theme_bw()+theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                   panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
                   legend.title=element_text(size=5),legend.text=element_text(size=5))+
  ggtitle("Percentile Residuals For Simulated Data")+xlab("Theoretical N(0,1)")+ylab("Percentile Residuals")+xlim(c(-5,5))+ylim(c(-5,5))
